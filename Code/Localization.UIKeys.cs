namespace Traffic
{
    public partial class Localization
    {
        public class UIKeys
        {
            ...
            public const string REMOVE_U_TURNS = Mod.MOD_NAME + ".UI.Tools[LaneConnector].Toolbox.Action[RemoveUturns]";
            public const string REMOVE_UNSAFE = Mod.MOD_NAME + ".UI.Tools[LaneConnector].Toolbox.Action[RemoveUnsafe]";
            ...
            public const string RESET_ACTION = Mod.MOD_NAME+"UI.Tools[Priorities].Toolbox.Action[Reset]";
            
            /*tooltips*/
            public const string REMOVE_ALL_CONNECTIONS_TOOLTIP_TITLE = Mod.MOD_NAME + ".UI.Tools[LaneConnector].Toolbox.Action[RemoveAllConnections].Tooltip.Title";
            public const string REMOVE_ALL_CONNECTIONS_TOOLTIP_MESSAGE = Mod.MOD_NAME + ".UI.Tools[LaneConnector].Toolbox.Action[RemoveAllConnections].Tooltip.Message";
            public const string REMOVE_U_TURNS_TOOLTIP_TITLE = Mod.MOD_NAME + ".UI.Tools[LaneConnector].Toolbox.Action[RemoveUTurns].Tooltip.Title";
