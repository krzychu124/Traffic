...
namespace Traffic.Systems.Serialization
{
    public partial class TrafficDataMigrationSystem
    {
        ...
        [BurstCompile]
#endif
        private struct FindIncompleteV2DataJob : IJobChunk
        {
            ...
            public void Execute(in ArchetypeChunk chunk, int unfilteredChunkIndex, bool useEnabledMask, in v128 chunkEnabledMask)
            {
                ...
                while (enumerator.NextEntityIndex(out int index))
                {
                    ...
                    {
                        ModifiedLaneConnections modifiedLaneConnection = modifiedConnections[i];
                        anyConnectionAffected |= modifiedLaneConnection.edgeEntity == Entity.Null ||
                            modifiedLaneConnection.modifiedConnections == Entity.Null || 
                            !dataOwnerData.HasComponent(modifiedLaneConnection.modifiedConnections);
                    }
